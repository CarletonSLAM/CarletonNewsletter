module.exports = {
    toast: [
        ...
        {
            tag: 'htmlString',
            text: `If you are having trouble viewing this as an email, click <a href='http://staylateandmake.ca/CarletonNewsletter/output/2019-01-21.html'>here</a> to view in browser.`
    ...
    articles: [
        // spac networking //
        {
            title: 'How to Network for SPAC 2019',
            date: 'Tues. Jan. 22, 2019',
            time: '17:45 - 18:45',
            location: 'ME 3380',
            img: 'spac-networking.png',
            body: [
                {
                    tag: 'p',
                    attr: {
                    ...
                    text: `Suit up and get ready for SPAC 2019. 🤵 This year is the largest SPAC yet with tons of new companies!!! 🙌🏻🙌🏻🙌🏻`
                },
                {
                    tag: 'p',
                    text: `However, if you're new to networking, this might be a challenge. SCESoc and IEEE Carleton have teamed up to teach you how to market yourself to employers the right way. 👉✔️`
                },
                {
                    tag: 'p',
                    text: `p.s. SPAC means Student Professional Awareness Conference`
                },
                {
                    tag: 'button',
                    attr: {
                        href: 'https://www.facebook.com/events/543455256134929/'
                    },
                    text: 'Facebook Event'
                },
            ]
