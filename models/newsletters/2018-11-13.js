module.exports = {
    toast: [
        ...
        {
            tag: 'htmlString',
            text: `If you are having trouble viewing this as an email, click <a href='http://staylateandmake.ca/CarletonNewsletter/output/2018-11-13.html'>here</a> to view in browser.`
    ...
    articles: [
        {
            ...
            body: [
                ...
                },
                {
                    ...
                    text: "We're having issues getting a room confirmation, we apologize for any confusion this may cause. Please follow the facebook event for the exact room."
                },
                {
                    tag: 'button',
                    attr: {
        ...
        },
        {
            ...
            body: [
                ...
                {
                    tag: 'p',
                    text: `This is MLH's 5th year organizing Local Hack Day. In 2017, the event brought out more than 6,000 participants across 34 countries and 236 cities around the world. This year's event is shaping up to be the biggest one yet!`
                },
                {
                    tag: 'p',
                    attr: {
