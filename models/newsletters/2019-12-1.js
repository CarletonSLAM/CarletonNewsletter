module.exports = {
    toast: [
        ...
        {
            tag: 'htmlString',
            text: `If you are having trouble viewing this as an email, click <a href='http://staylateandmake.ca/CarletonNewsletter/output/2019-12-1.html'>here</a> to view in browser.`
        }
    ],
    articles: [
        // --- SLAM --- //
            ...
            body: [
                {
                    ...
                    text: `Note: last SLAM session of the year on Tuesday Dec 3.`
                },
                {
                    tag: 'p',
            ...
            body: [
                {
                    ...
                    text: `MLH Local Hack Day: Build is coming to Carleton on December 7th!`
                },
                {
                    tag: 'p',
                    text: `Join us and students all around the world in this global day-long hack day! It will be a day full of making a new projects, learning new skills, and meet other students interested in software, hardware, and technology.`
                },
                {
                    tag: 'p',
                ...
                },
                {
                    ...
                    text: `If you’d like to attend, please register at the link below.`
                },
                {
                    tag: 'button',
                    attr: {
                        href: 'https://localhackday.mlh.io/build/locations/2531'
                    },
                    text: `Sign-up`
                },
                {
                    tag: 'button',
                    attr: {
                        href: 'https://www.facebook.com/events/3501446513213934/'
                    },
                    text: `Facebook Event`
                },
            ]
        },
        // --- cuHacking Applications --- //
        {
            title: `cuHacking 2020: Applications are Open!`,
            img: `cuhacking-apps.png`,
            body: [
                {
                    tag: 'p',
                    attr: {
                    ...
                    text: `cuHacking is back, bigger and better than ever!`
                },
                {
                    tag: 'p',
                    text: `Carleton's annual MLH hackathon is an amazing opportunity for you and your team to spend a day working on anything you'd like!`
                },
                {
                    tag: 'p',
                    text: `cuHacking 2020 once again will be hosted in River Building (Richcraft Hall) on January 11 + 12, 2020. Join cuHacking, IEEE Carleton, and other student clubs along with industry professionals and over 400 students to build something over the weekend. It's gonna be a lot of fun!`
                },
                {
                    tag: 'p',
                    text: `There will be awesome workshops, networking opportunities, and fun activities throughout the event.`
                },
                {
                    tag: 'htmlString',
                    text: `Applications are now open on <a href="https://cuhacking.com">cuhacking.com</a>.`
                },
                {
                    tag: 'p',
                    attr: {
                    ...
                    text: `Applications are open until Dec. 9 at 11:59 PM, don't procrastinate!`
                },
                {
                    tag: 'button',
                    attr: {
